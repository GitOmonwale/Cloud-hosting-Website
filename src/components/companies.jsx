...
function Companies( ) {
    return <>
    <div className="flex flex-col gap-4 justify-center items-center text-center pt-10 max-w-1000 m-auto lg:px-10 px-20">
...
<div className="flex flex-wrap justify-between items-center text-4xl w-full">
